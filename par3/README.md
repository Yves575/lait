...
Public-release note: this directory keeps PAR3-related code, metadata, license,
and citation information. Dataset files and HTML alignment views that embed
source or human-translation text are withheld from this GitHub branch.
